...
const twitterElement = document.getElementById("X");
const companyContainer = document.getElementById("company-container");
const blogContainer = document.getElementById("blog-container");
const twitterContainer = document.getElementById("X-container");
...
async function displayUserData(user) {
  ...
  stars.textContent = "…";
  stars.textContent = await fetchStarredCount(user.login);
...
async function fetchStarredCount(username) {
  try {
